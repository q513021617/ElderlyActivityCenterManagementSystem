...
public class AccountController {
    ...
    public Result<Account> login(@RequestBody Account account,  HttpServletRequest request) {
        ...
        if (level.equals("管理员")) {
            ...
            login = laonianrenInfoService.login(account.getUsername(), account.getMima());
    ...
    public Result<Object> getAccountInfo(HttpServletRequest request) {
		...
		if (level.equals("老年人")) { return Result.success(laonianrenInfoService.findById(account.getId())); }
    ...
    public Result updateMima(@RequestBody Account info, HttpServletRequest request) {
        ...
        if (level.equals("管理员")) {
            ...
            LaonianrenInfo laonianrenInfo = new LaonianrenInfo();
            BeanUtils.copyProperties(info, laonianrenInfo);
